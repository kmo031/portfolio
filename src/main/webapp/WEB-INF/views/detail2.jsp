...
<body>
	...
	<header id="header">
		...
		<div class="content-container">
			...
			<h1 id="logo">
				<a href="/index.html"> <img src="/resources/images/logo.png" alt="뉴렉처 온라인" />
				...
				<nav class="menu">
					...
					<ul>
						<li><a target="_blank" href="http://www.notepubs.com"><img
								src="/resources/images/notepubs.png" alt="노트펍스" /></a></li>
						<li><a target="_blank" href="http://www.namoolab.com"><img
								src="/resources/images/namoolab.png" alt="나무랩연구소" /></a></li>
	...
	<footer id="footer">
		<div class="content-container">
			<h2 id="footer-logo">
				<img src="/resources/images/logo-footer.png" alt="회사정보">
			</h2>
