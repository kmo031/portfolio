			...
			<form name="frm" action="#" method="post">
				...
				<fieldset class="form-group">
					...
					<div class="form-group">
							...
							<input class="form-control form-control-lg" type="text" name="title" value="<c:out value='${board.title }' />">
					</div>
					<div class="form-group">
...
$(function(){
      nhn.husky.EZCreator.createInIFrame({
          ...
          fOnAppLoad : function(){
              ...
              oEditors.getById["textAreaContent"].exec("PASTE_HTML", ["${board.content}"]);
          },
